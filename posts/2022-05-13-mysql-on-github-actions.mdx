...
I'm $hello$ currently working on a project that relies heavily on a relational
...
<summary>
  Full working yaml file (this goes into
  <code>.github/workflows/cool-name.yml</code>)
</summary>
